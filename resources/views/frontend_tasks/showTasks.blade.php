                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                            <h5 class="font-15"><a href="/Tasks/created/showtasks" class="completed-tasks-link" style="color: black;">Show Tasks <br><br>  </a></h5>
                                ...
                                <div class="align-items-center justify-content-between">
                                    <div class="row ">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                            <div class="card-content">
                                                <!-- Display button for Manager -->
                                                <h5 class="font-15"><a href="/Tasks/created/mytasks" class="manager-button-link" style="color: black;">My Tasks</a></h5>
                                                <!-- Display button for non-Manager roles -->
                                                <h2 class="mb-3 font-18"></h2>
                                                {{-- <p class="mb-0"><span class="col-green">10%</span> Increase</p> --}}
                                            </div>
